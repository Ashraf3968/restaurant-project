...
export const defaultState = {
  ...
  users: [
    ...
    { id: 'u-3', firstName: 'Sofia', lastName: 'D'Souza', email: 'sofia.dsouza@example.com', phone: '+91 99200 31771', password: 'guestpass123', role: 'member' }
  ],
  menuItems: [
    ...
    { id: 'm2', name: 'Coal-Roasted Heirloom Carrot', category: 'Starters', price: 760, tags: ['Vegetarian'], dietary: ['Gluten-free'], popular: false, description: 'Whipped chevre, toasted seeds, saffron honey, and herb ash.' },
    ...
    { id: 'm5', name: 'Forest Truffle Risotto', category: 'Main Course', price: 1680, tags: ['Vegetarian', 'Chef recommended'], dietary: ['Vegetarian'], popular: false, description: 'Aged carnaroli, shaved truffle, cultured butter, and parmesan foam.' },
    ...
    { id: 'm7', name: 'Vanilla Bean Mille-Feuille', category: 'Desserts', price: 640, tags: ['Chef recommended'], dietary: ['Vegetarian'], popular: false, description: 'Crisp pastry, vanilla diplomat, and poached pear compote.' },
    { id: 'm8', name: 'Botanical Citrus Spritz', category: 'Beverages', price: 540, tags: ['Non-alcoholic'], dietary: ['Vegan'], popular: false, description: 'White tea cordial, citrus oils, botanical tonic, and mint vapor.' },
  ...
  reservations: [
    ...
    { id: 'r3', name: 'Sofia D\'Souza', email: 'sofia.dsouza@example.com', phone: '+91 99200 31771', date: '2026-03-29', time: '7:30 PM', guests: '3', occasion: 'Birthday', request: 'Vegetarian tasting', status: 'Confirmed' }
  ],
  reviews: [
...
export const galleryItems = [
  ...
  'Open-fire kitchen pass',
  'Private suite styling',
  'Sommelier reserve wall',
  'Chef plating finish',
  'Terrace evening service',
  'Signature cocktail moment',
  'Tasting menu presentation',
  'Weekend live jazz setup'
];
